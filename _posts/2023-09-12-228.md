...
tags: [docstring, python, sphinx]
date: 2023-09-12 00:11:32 +0900
uid: 228
...
![스크린샷 2023-09-12 오후 3.10.46.png](https://i.imgur.com/duTRwrH.png)
...
![스크린샷 2023-09-12 오후 3.11.16.png](https://i.imgur.com/oPXjI3v.png)

## 테마 변경하기

기본 테마는 위의 이미지처럼 깔끔하지 않다. 따라서 다양한 테마를 다운받아 직접 적용할 수 있다.

([Sphinx 테마 갤러리](http://sphinx-themes.org)에 접속하면 다양한 테마 목록을 확인할 수 있다.)
...
위의 패키지를 설치한 이후에, sphinx 로 설정한 source 디렉토리에 들어가서 [conf.py](http://conf.py) 파일에 테마 이름을 수정하고, `make html` 명령어로 새로 빌드하면 html 화면이 rtd 테마로 변경된다.
...
![스크린샷 2023-09-12 오후 3.12.02.png](https://i.imgur.com/zY8IQGB.png)
...
그리고 [conf.py](http://conf.py) 파일에서 해당 extension을 추가한다.
...
![스크린샷 2023-09-13 오후 1.56.37.png](https://i.imgur.com/zNXr4PU.png)

![스크린샷 2023-09-13 오후 1.57.20.png](https://i.imgur.com/lmjEDyn.png)
...
다시 [conf.py](http://conf.py) 파일에서 extensions 부분에 sphinx.ext.napoleon을 추가해준다. 그리고 하단에 어떤 style의 docstring을 사용할 건지 True/False를 입력해주면 된다.
